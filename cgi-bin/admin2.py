...
if site_name == "admin" and site_url == "cobot#2018":
	...
	print "<button class='layui-btn' id='business' onclick='workergongshi()'>两周内未提交工时人员</button>"
	print "<button class='layui-btn' id='business' onclick='managergongshi()'>两周内未审批工时人员</button>"
	print "</div>"
	print "<p>说明<p>"
 	print "<p>1.添加项目时是默认激活的<p>"
	print "<p>2.如果数据没有加载出来，请刷新页面<p>"
	print "<p>3.您此时修改激活状态，考虑到已经填报的工时，下一周才会禁止填写（准确的说是下一个星期一早上），请谨慎修改状态<p>"
	print "<p>4.导出的两周是上一周，上两周<p>"
	print "    </div>"
	print "  </div>"
	...
	print "<script src = '../js/admin27.js'></script>"
	print "</body>"
	print "</html>"
