...
print "                <option value='' lay-filter='fourweek'>%s</option>"%(last_four)
...
print "                <option value='4' lay-filter='fourweek' selected>%s</option>"%(last_four)
print "            </select>"
...
print  "      <div class='layui-row'  style='margin-bottom:40px'>"
...
print  "        <button class='layui-btn' id='newcsv'>导出项目工时</button>"
print  "      </div>"
print  "      <p>审批说明<p>"
...
print  "<script src='../js/waitforme5.js'></script>"
