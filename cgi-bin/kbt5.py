...
if username != []:
  ...
  print "                <option value='' >%s</option>"%(last_four)
  print "              <option value='0'>%s</option>"%(last_zero)
  print "                <option value='1' >%s</option>"%(last_one)
  print "               <option value='2'>%s</option>"%(last_two)
  print "                <option value='3'>%s</option>"%(last_three)
  print "                <option value='4'  selected>%s</option>"%(last_four)
  print "            </select>"
  ...
  print "      <p>5.表格中只会显示审批通过的和未审批的数据，其中未审批的数据可以修改和删除</p>"
  print "    </div>"
  print "  </div>"
  ...
  print "<script src='../js/gongshi7.js'></script>"
  print "</body>"
  print "</html>"
